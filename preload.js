...
contextBridge.exposeInMainWorld("watcherApi", {
  ...
  listStreamSources: () => ipcRenderer.invoke("watcher:list-stream-sources"),
  streamJson: (payload) => ipcRenderer.invoke("watcher:stream-json", payload),
  streamChunk: (payload) => ipcRenderer.invoke("watcher:stream-chunk", payload),
